      ...
      <div className="min-h-dvh flex items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full max-w-md px-6 relative z-10">
          <div className="glass-card rounded-3xl p-10 text-center glow-border">
            <div className="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-full bg-gradient-to-br from-violet-500 to-violet-600 shadow-lg shadow-violet-500/30 animate-float">
      ...
      <div className="w-full max-w-md px-6 relative z-10">
        ...
        <div className="glass-card rounded-3xl p-8 glow-border">
          ...
          <div className="mt-8 text-center">
            <Link
              to="/login"
              className="text-sm text-gold-500 hover:text-gold-400 font-medium inline-flex items-center gap-2 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
